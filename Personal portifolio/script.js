...
const arrowRight = document.querySelector('.portifolio-box .navigation .arrow-right');
const arrowLeft = document.querySelector('.portifolio-box .navigation .arrow-left');
